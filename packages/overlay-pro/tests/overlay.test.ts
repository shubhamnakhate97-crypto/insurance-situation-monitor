...
import { createSyntheticPortfolio, exposureWeightedAlerts, requirePro, screenOwnershipChain } from "../src";
...
describe("pro invariants",()=>{
  ...
  it("fails closed for non-pro users",()=>{ expect(()=>requirePro({userId:"x",tier:"free-registered",source:"none"})).toThrow("PRO_ENTITLEMENT_REQUIRED"); });
