...
export const rdsScenarios: RdsScenario[] = [
  ...
  { id: "rds-europe-wind", name: fact("RDS 04 — Northwest Europe windstorm", lensMethod), peril: "Windstorm", footprint: fact([{lat:48,lon:-7},{lat:57,lon:-7},{lat:57,lon:10},{lat:48,lon:10},{lat:48,lon:-7}],lensMethod), narrative: fact("Synthetic pan-European wind footprint inspired by market RDS practice; no licensed footprint or loss model is reproduced.",lensMethod), severity: fact(.82,lensMethod) },
  { id: "rds-california-quake", name: fact("RDS 05 — California earthquake", lensMethod), peril: "Earthquake", footprint: fact([{lat:32,lon:-123},{lat:39,lon:-123},{lat:39,lon:-116},{lat:32,lon:-116},{lat:32,lon:-123}],lensMethod), narrative: fact("Synthetic shaking extent for accumulation exploration; not a hazard-model output.",lensMethod), severity: fact(.89,lensMethod) },
  { id: "rds-cloud-outage", name: fact("RDS 06 — Systemic cloud-service outage", lensMethod), peril: "Cyber", footprint: fact([{lat:-55,lon:-180},{lat:75,lon:-180},{lat:75,lon:180},{lat:-55,lon:180},{lat:-55,lon:-180}],lensMethod), narrative: fact("Illustrative global dependency scenario. Geographic inclusion is a proxy and not an estimate of technology dependency or loss.",lensMethod), severity: fact(.76,lensMethod) },
  { id: "rds-city-terrorism", name: fact("RDS 07 — Major city-centre terrorism event", lensMethod), peril: "Terrorism", footprint: fact([{lat:51.45,lon:-.24},{lat:51.60,lon:-.24},{lat:51.60,lon:.08},{lat:51.45,lon:.08},{lat:51.45,lon:-.24}],lensMethod), narrative: fact("Synthetic city-centre blast and denial-of-access context for aggregation review; not an attack forecast.",lensMethod), severity: fact(.68,lensMethod) },
];
